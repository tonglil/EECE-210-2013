 ...
 */
public class IfStatement extends AstNode implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
    	IfStatement newNode = new IfStatement(this.position, this.length);
    	newNode.setCondition(this.condition);
    	newNode.setThenPart(this.getThenPart());
    	newNode.setElsePosition(this.getElsePosition());
    	newNode.setElsePart(this.getElsePart());
    	newNode.setLp(this.getLp());
    	newNode.setRp(this.getRp());

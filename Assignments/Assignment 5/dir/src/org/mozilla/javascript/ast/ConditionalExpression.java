 ...
 */
public class ConditionalExpression extends AstNode implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
    	ConditionalExpression newNode = new ConditionalExpression(this.position, this.length);
    	newNode.setTestExpression(this.testExpression);
    	newNode.setTrueExpression(this.trueExpression);
    	newNode.setFalseExpression(this.falseExpression);
    	newNode.setQuestionMarkPosition(this.questionMarkPosition);
    	newNode.setColonPosition(this.colonPosition);

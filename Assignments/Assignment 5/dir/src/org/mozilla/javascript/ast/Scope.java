 ...
 */
public class Scope extends Jump implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
    	Scope newNode = new Scope(this.position, this.length);
    	newNode.symbolTable = this.symbolTable;
    	newNode.parentScope = this.parentScope;
    	newNode.top = this.top;
    	newNode.childScopes = this.childScopes;

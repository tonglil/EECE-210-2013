 ...
 * {@link Token#ERROR}.<p>
 */
public class ErrorNode extends AstNode implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
    	ErrorNode newNode = new ErrorNode(this.position, this.length);
    	newNode.setMessage(this.getMessage());

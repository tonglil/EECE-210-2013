 ...
 */
public class ParenthesizedExpression extends AstNode implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
    	ParenthesizedExpression newNode = new ParenthesizedExpression(this.position, this.length, this.expression);

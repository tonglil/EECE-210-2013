 ...
 */
public class Jump extends AstNode implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
    	Jump newNode = new Jump(this.type);
    	newNode.setContinue(this.getContinue());
    	newNode.setLoop(this.getLoop());
    	newNode.setDefault(this.getDefault());
    	newNode.setFinally(this.getFinally());
    	newNode.setJumpStatement(this.getJumpStatement());

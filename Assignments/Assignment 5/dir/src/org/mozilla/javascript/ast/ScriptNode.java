 ...
 */
public class ScriptNode extends Scope implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
    	ScriptNode newNode = new ScriptNode(this.position);
    	newNode.encodedSourceStart = this.encodedSourceStart;
    	newNode.encodedSourceEnd = this.encodedSourceEnd;
    	newNode.sourceName = this.sourceName;
    	newNode.encodedSource = this.encodedSource;
    	newNode.endLineno = this.endLineno;
    	newNode.functions = this.functions;
    	newNode.regexps = this.regexps;
    	newNode.symbols = this.symbols;
    	newNode.paramCount = this.paramCount;
    	newNode.variableNames = this.variableNames;
    	newNode.isConsts = this.isConsts;
    	newNode.compilerData = this.compilerData;
    	newNode.tempNumber = this.tempNumber;

 ...
 * expression.
 */
public class FunctionNode extends ScriptNode implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
    	FunctionNode newNode = new FunctionNode(this.position, this.getFunctionName());
    	newNode.setParams(this.getParams());
    	newNode.setBody(this.getBody());
    	newNode.setIsExpressionClosure(this.isExpressionClosure);
    	newNode.functionForm = this.functionForm;
    	newNode.setLp(this.lp);
    	newNode.setRp(this.rp);
    	newNode.setFunctionType(this.getFunctionType());
    	newNode.needsActivation = this.needsActivation;
    	newNode.ignoreDynamicScope = this.ignoreDynamicScope;
    	newNode.isGenerator = this.isGenerator;
    	newNode.generatorResumePoints = this.generatorResumePoints;
    	newNode.liveLocals = this.liveLocals;
    	newNode.memberExprNode = this.memberExprNode;

 ...
 */
public class FunctionCall extends AstNode implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
    	FunctionCall newNode = new FunctionCall(this.position, this.length);
    	newNode.setTarget(this.getTarget());
    	newNode.setArguments(this.arguments);

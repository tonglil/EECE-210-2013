 ...
 */
public class UnaryExpression extends AstNode implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
    	UnaryExpression newNode = new UnaryExpression(this.position, this.length);
    	newNode.setOperator(this.getOperator());
    	newNode.setOperand(this.getOperand());
    	newNode.setIsPostfix(this.isPostfix);

 ...
 */
public class ExpressionStatement extends AstNode implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
    	ExpressionStatement newNode = new ExpressionStatement(this.position, this.length, this.getExpression());

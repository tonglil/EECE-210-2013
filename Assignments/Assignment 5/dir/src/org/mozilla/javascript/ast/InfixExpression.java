 ...
 */
public class InfixExpression extends AstNode implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
    	InfixExpression newNode = new InfixExpression(this.position, this.length, this.left, this.right);

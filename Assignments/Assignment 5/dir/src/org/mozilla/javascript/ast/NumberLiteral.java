 ...
 */
public class NumberLiteral extends AstNode implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
    	NumberLiteral newNode = new NumberLiteral(this.position, this.length);
    	newNode.setValue(this.value);
    	newNode.setNumber(this.number);

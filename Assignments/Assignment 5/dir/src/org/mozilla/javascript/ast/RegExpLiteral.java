 ...
 */
public class RegExpLiteral extends AstNode implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
    	RegExpLiteral newNode = new RegExpLiteral(this.position, this.length);
    	newNode.setValue(this.value);
    	newNode.setFlags(this.flags);

...
public class Parser
{
    ...
    */
    ...
    public AstRoot parse(String sourceString, String sourceURI, int lineno)
    {
        ...
        this.ts = new TokenStream(null, sourceString, lineno);
        try {
            return parse();
        ...
        throws IOException
    {
        ...
        try {
            this.sourceURI = sourceURI;
            ts = new TokenStream(sourceReader, null, lineno);
            return parse();
        } finally {
            parseFinished = true;
        }
    ...
    private AstRoot parse() throws IOException
    {
        ...
        if (this.syntaxErrorCount != 0) {
            ...
            System.out.println("Got syntax errors");
            System.exit(-1);
        }
                ...
                if (mustMatchToken(Token.NAME, "msg.no.parm")) {
                    ...
                    if (this.inUseStrictDirective) {
                        ...
                        if (paramNames.contains(paramName))
                            System.out.println("Duplicate param names");
        ...
        throws IOException
    {
        ...
        if (data.condition instanceof Assignment) {
            System.out.println("msg.equal.as.assign");
        }
        return data;
    }
        ...
        switch (ttFlagged & CLEAR_TI_MASK) {
          ...
          default:
              if ((ttFlagged & TI_AFTER_EOL) == 0) {
                  ...
                  System.out.println("msg.no.semi.stmt");
              } else {
                  warnMissingSemi(pos, nodeEnd(pn));
              }
              break;
    ...
    */
    ...
    {
        if (!insideFunction()) {
            System.out.println(tt == Token.RETURN ? "msg.bad.return"
                                           : "msg.bad.yield");
        }
        consumeToken();
        int lineno = ts.lineno, pos = ts.tokenBeg, end = ts.tokenEnd;
        ...
        if (tt == Token.RETURN) {
            ...
            if (nowAllSet(before, endFlags,
                ...
                System.out.println("msg.return.inconsistent");
        }
        ...
        if (insideFunction()
            ...
            if (name == null || name.length() == 0)
                System.out.println("msg.anon.generator.returns");
            else
                System.out.println("msg.generator.returns");
        }
    ...
    */
    ...
    void defineSymbol(int declType, String name, boolean ignoreNotInBlock) {
        ...
        {
            System.out.println(symDeclType == Token.CONST ? "msg.const.redecl" :
        ...
        switch (declType) {
          case Token.LET:
              if (!ignoreNotInBlock &&
                  ...
                  System.out.println("msg.let.decl.not.in.block");
                  return;
              }
          ...
          case Token.FUNCTION:
              if (symbol != null) {
                  if (symDeclType == Token.VAR)
                      System.out.println("msg.var.redecl");
                  else if (symDeclType == Token.LP) {
                      System.out.println("msg.var.hides.arg");
                  }
              } else {
          ...
          case Token.LP:
              if (symbol != null) {
                  ...
                  System.out.println("msg.dup.parms");
              }
              currentScriptOrFn.putSymbol(new Symbol(declType, name));
              return;
        ...
        throws IOException
    {
        ...
        while (matchToken(Token.COMMA)) {
            ...
            if (peekToken() == Token.YIELD)
                System.out.println("msg.yield.parenthesized");
            ...
            switch (tt) {
              ...
              case Token.LP:
                  ...
                  if (args != null && args.size() > ARGC_LIMIT)
                      System.out.println("msg.too.many.function.args");
                  f.setArguments(args);
        ...
        switch(tt) {
          ...
          case Token.NUMBER: {
              ...
              if (this.inUseStrictDirective && ts.isNumberOctal()) {
                  System.out.println("msg.no.octal.strict");
              }
          ...
          case Token.RESERVED:
              System.out.println("msg.reserved.id");
              break;
          ...
          case Token.EOF:
              System.out.println("msg.unexpected.eof");
              break;

          default:
              System.out.println("msg.syntax");
              break;
        }
    ...
    */
    ...
    private void checkBadIncDec(UnaryExpression expr) {
        ...
        if (!(tt == Token.NAME
              ...
              || tt == Token.GET_REF
              || tt == Token.CALL))
            System.out.println(expr.getType() == Token.INC
                        ? "msg.bad.incr"
                        : "msg.bad.decr");
    }
    ...
    */
    ...
    protected Node simpleAssignment(Node left, Node right) {
        ...
        switch (nodeType) {
          case Token.NAME:
              ...
              {
                  System.out.println("msg.bad.id.strict");
              }
    ...
    protected void checkMutableReference(Node n) {
        ...
        if ((memberTypeFlags & Node.DESCENDANTS_FLAG) != 0) {
            System.out.println("msg.bad.assign.left");
        }
    }
    ...
    */
    ...
    {
    	this.sourceURI = sourceURI;
    	this.ts = new TokenStream(sourceReader, null, lineno);
    	return ts;
    }
}
